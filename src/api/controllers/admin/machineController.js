...
module.exports = {
    ...
    getList: async (req, res, next) => {
        try {
            ...
            queryOption.projection = { machineCode: 1, machineName: 1, workspaceId: 1, ip: 1, deviceType: 1, displayType: 1, machineType: 1 };
    ...
    update: async (req, res, next) => {
        try {
            ...
            const result = await machineService.findByIdAndUpdate(machineId, reqBody, {
                projection: { machineCode: 1, machineName: 1, workspaceId: 1, ip: 1, deviceType: 1, displayType: 1, machineType: 1 },
