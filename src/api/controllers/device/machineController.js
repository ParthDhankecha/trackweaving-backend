...
module.exports = {
    getMachineList: async (req, res, next) => {
        try {
            ...
            const machines = await machineService.find({ workspaceId, isDeleted: false }, { populate: 'machineGroupId', projection: 'serialNumber machineCode machineName ip machineGroupId maxSpeedLimit isAlertActive' });
