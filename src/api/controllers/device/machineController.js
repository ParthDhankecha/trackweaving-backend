...
module.exports = {
    getMachineList: async (req, res, next) => {
        try {
            ...
            const machines = await machineService.find({ workspaceId, isDeleted: false }, { populate: 'machineGroupId', projection: 'serialNumber machineCode machineName quality reed ip machineGroupId maxSpeedLimit isAlertActive' });
