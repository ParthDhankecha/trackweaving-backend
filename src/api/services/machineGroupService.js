...
module.exports = { 
    async create(body){
        const machineGroup = new machineGroupModel(body);
        return await machineGroup.save();
    },
    ...
    async find(options = {}, queryOptions = {}){
        ...
        const query = machineGroupModel.find({ ...options, isDeleted: false });
    ...
    async findOne(options = {}, queryOptions = {}) {
        ...
        const query = machineGroupModel.findOne({ ...options, isDeleted: false });
    ...
    async findByIdAndUpdate(_id, data) {
        return await machineGroupModel.findByIdAndUpdate({ _id: _id }, data, { new: true });
    },

    async findByIdAndDelete(_id) {
        return await machineGroupModel.findByIdAndUpdate({ _id: _id }, { isDeleted: true }, { new: true });
    }
}